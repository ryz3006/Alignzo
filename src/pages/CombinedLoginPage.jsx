...
const TabButton = ({ active, onClick, children }) => (
    <button type="button" onClick={onClick} style={{flex: 1, padding: '1rem', fontWeight: '600', borderBottom: '4px solid transparent', transition: 'all 0.3s ease', color: active ? 'var(--light-primary)' : 'var(--light-text)'}} className={active ? 'active-tab' : ''}>
  ...
  return (
    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: '1rem'}}>
      <div className="neumorph-outset" style={{width: '100%', maxWidth: '420px', padding: '2rem'}}>
        ...
        <div className="neumorph-inset" style={{display: 'flex', marginBottom: '1.5rem', borderRadius: '12px'}}>
