...
const TabButton = ({ active, onClick, children }) => (
    <button type="button" onClick={onClick} className={`w-1/2 py-3 text-center font-semibold border-b-2 transition-colors ${active ? 'border-blue-500 text-blue-500 dark:border-blue-400 dark:text-blue-400' : 'border-transparent text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-white'}`}>
        {children}
    </button>
);
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 font-sans">
      <div className="w-full max-w-sm p-8 space-y-6 bg-white rounded-2xl shadow-xl dark:bg-gray-800">
        <div className="text-center">
            <img src={LogoOnly} alt="Alignzo Logo" className="w-20 h-20 mx-auto mb-4" />
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Alignzo</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-2">Smarter Alignment. Smarter Operations.</p>
        </div>
