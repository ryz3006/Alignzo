...
const UsersIcon = () => <svg style={{height: '1.5rem', width: '1.5rem'}} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.003A6.375 6.375 0 0112 21c-2.292 0-4.243-.99-5.625-2.624M9.75 16.575v.003c0-1.113.285-2.16.786-3.07M9.75 16.575v-.003A6.375 6.375 0 0012 21c2.292 0 4.243-.99 5.625-2.624M12 10.5a3 3 0 11-6 0 3 3 0 016 0z" /></svg>;
